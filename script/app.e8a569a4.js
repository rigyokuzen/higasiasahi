dianpinPlus([9], [, , , function(e, t, n) {
    ...
    function r() {
        ...
        C = _.reduce(function(e, t) { return n.i(i.a)(e, t) }, C);
        return C
    }
    var o = (n(21), n(5)),
        i = n(3),
    ...
    var u = function() {
        ...
        ee = function(e) {
            ...
            return a(t, e), u(t, [{
                ...
                value: function() {
                    (0, g.default)();
                    return d.default.createElement(p.HashRouter, null, this.state.initDone ? d.default.createElement("div", { id: "app" }, d.default.createElement(p.Switch, null, d.default.createElement(p.Route, { exact: !0, path: "/", component: O.default }), d.default.createElement(p.Route, { exact: !0, path: "/city", render: function(e) { return d.default.createElement(G, { props: e }) } }), d.default.createElement(p.Route, { path: "/search2/:shopid/:deskid", render: function(e) { return d.default.createElement(B, { props: e }) } }), d.default.createElement(p.Route, { path: "/search/:category/:keyword?", render: function(e) { return d.default.createElement(Z, { props: e }) } }), d.default.createElement(p.Route, { path: "/detail/:id", render: function(e) { return d.default.createElement(Q, { props: e }) } }), d.default.createElement(p.Route, { exact: !0, path: "/user", render: function(e) { return d.default.createElement(Y, { props: e }) } }), d.default.createElement(p.Route, { exact: !0, path: "/sign", render: function(e) { return d.default.createElement(K, { props: e }) } }), d.default.createElement(p.Route, { exact: !0, path: "/signup", render: function(e) { return d.default.createElement(J, { props: e }) } }), d.default.createElement(p.Route, { exact: !0, path: "/custom", render: function(e) { return d.default.createElement(X, { props: e }) } }), d.default.createElement(p.Route, { render: function(e) { return d.default.createElement($, { props: e }) } }))) : d.default.createElement("div", null, "正在加载..."))
                }
            }, { key: "componentDidMount", value: function() { this.setState({ initDone: !0 }) } }]), t
        }(c.Component);
    t.default = (0, b.connect)(l, s)(ee)
}, function(e, t, n) {
    "use strict";
    ...
    "use strict";
    e.exports = { imgUrl: "http://higasi.herokuapp.com", port: "3000" }
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(5),
        ...
        m = i.forwardRef(function(e, t) {
            var a = e.children,
                ...
                I = E && i.createElement("span", { className: n.i(l.default)(s.endIcon, s["iconSize".concat(n.i(d.a)(P))]) }, E);
    ...
    var r = n(1),
        ...
        h = i.forwardRef(function(e, t) {
            ...
            var ne = n.i(f.a)(),
                ...
                oe = ne.onBlurVisible,
                ie = ne.ref;
            i.useImperativeHandle(p, function() { return { focusVisible: function() { te(!0), Y.current.focus() } } }, []), i.useEffect(function() { ee && T && !C && Q.current.pulsate() }, [C, T, ee]);
            var ae = d("start", z),
                le = d("stop", q),
                se = d("stop", H),
            ...
            var we = n.i(u.a)(h, t),
                ...
                Oe = Se[0],
                Ce = Se[1];
            i.useEffect(function() { Ce(!0) }, []);
            var Pe = Oe && !C && !S;
            return i.createElement(ye, n.i(r.a)({ className: n.i(s.default)(y.root, x, ee && [y.focusVisible, R], S && y.disabled), onBlur: me, onClick: N, onFocus: pe, onKeyDown: ve, onKeyUp: be, onMouseDown: ae, onMouseLeave: ue, onMouseUp: se, onDragLeave: le, onTouchEnd: de, onTouchMove: fe, onTouchStart: ce, ref: ke, tabIndex: S ? -1 : X }, xe, Z), b, Pe ? i.createElement(m.a, n.i(r.a)({ ref: Q, center: v }, J)) : null)
        });
        ...
        m = a.forwardRef(function(e, t) {
            ...
            var S = a.useCallback(function(e) {
                ...
                P = a.useCallback(function(e, t) {
                    if (clearTimeout(w.current), "touchend" === e.type && E.current) return e.persist(), E.current(), E.current = null, void(w.current = setTimeout(function() { P(e, t) }));
                    E.current = null, v(function(e) { return e.length > 0 ? e.slice(1) : e }), y.current = t
                }, []);
            return a.useImperativeHandle(t, function() { return { pulsate: C, start: O, stop: P } }, [C, O, P]), a.createElement("span", n.i(r.a)({ className: n.i(u.default)(f.root, m), ref: k }, p), a.createElement(s.a, { component: null, exit: !0 }, g))
        });
    ...
    function o(e) {
        ...
        var o = e.primary,
            ...
            z = { dark: b, light: v };
        return n.i(l.a)(n.i(i.a)({ common: s.a, type: R, primary: U(y), secondary: U(w, "A400", "A200", "A700"), error: U(k), warning: U(O), info: U(P), success: U(j), grey: u.a, contrastThreshold: N, getContrastText: t, augmentColor: U, tonalOffset: I }, z[R]), L)
    }
    t.a = o;
    var i = n(1),
        a = n(5),
    ...
    function o(e, t) {
        ...
        return n.i(l.a)(n.i(i.a)({ htmlFontSize: k, pxToRem: _, round: r, fontFamily: d, fontSize: m, fontWeightLight: h, fontWeightRegular: v, fontWeightMedium: y, fontWeightBold: w }, T), C, { clone: !1 })
    }
    t.a = o;
    var i = n(1),
        a = n(5),
            ...
            V = {
                ...
                createHref: function(e) {
                    var t = document.querySelector("base"),
                        n = "";
                    return t && t.getAttribute("href") && (n = E(window.location.href)), n + "#" + P(w + d(e))
                },
                push: function(e, t) {
    ...
    function _(e) {
        ...
        function r(e) {
            var n = P(x.index + e, 0, x.entries.length - 1),
                r = x.entries[n];
    ...
    t.createBrowserHistory = w, t.createHashHistory = C, t.createMemoryHistory = _, t.createLocation = f, t.locationsAreEqual = m, t.parsePath = c, t.createPath = d
}, function(e, t, n) {
    "use strict";
    n(234)("createBrowserHistory"), e.exports = n(233).createBrowserHistory
}, function(e, t, n) {
    "use strict";
    e.exports = n(231)
}, function(e, t, n) {
            ...
            function u(e, n, r) {
                ...
                var o = +new Date,
                    i = setInterval(function() {
                        var a = +new Date - o;
                        if (a > r) return y.style.left = n + "px", C && c(), t.transitionEnd && t.transitionEnd.call(event, E, h[E]), void clearInterval(i);
            ...
            if (e) {
                ...
                var x, w, E = parseInt(t.startSlide, 10) || 0,
                    ...
                    j = {
                        ...
                        start: function(e) {
                            var t = e.touches[0];
                            P = { x: t.pageX, y: t.pageY, time: +new Date }, w = void 0, _ = {}, y.addEventListener("touchmove", this, !1), y.addEventListener("touchend", this, !1)
                        },
                        move: function(e) {
                            if (!(e.touches.length > 1 || e.scale && 1 !== e.scale || t.disableScroll)) {
                                var n = e.touches[0];
                                _ = { x: n.pageX - P.x, y: n.pageY - P.y }, void 0 === w && (w = !!(w || Math.abs(_.x) < Math.abs(_.y))), w || (e.preventDefault(), d(), O ? (s(i(E - 1), _.x + g[i(E - 1)], 0), s(E, _.x + g[E], 0), s(i(E + 1), _.x + g[i(E + 1)], 0)) : (_.x = _.x / (!E && _.x > 0 || E == h.length - 1 && _.x < 0 ? Math.abs(_.x) / v + 1 : 1), s(E - 1, _.x + g[E - 1], 0), s(E, _.x + g[E], 0), s(E + 1, _.x + g[E + 1], 0)), t.swiping && t.swiping(-_.x / v))
                            }
                        },
                        end: function(e) {
                            var n = +new Date - P.time,
                        ...
                        transitionEnd: function(e) { parseInt(e.target.getAttribute("data-index"), 10) == E && (C && c(), t.transitionEnd && t.transitionEnd.call(e, E, h[E])) }
                    };
                return n(), C && c(), p.addEventListener ? (p.touch && (y.addEventListener("touchstart", j, !1), y.addEventListener("touchforcechange", function() {}, !1)), p.transitions && (y.addEventListener("webkitTransitionEnd", j, !1), y.addEventListener("msTransitionEnd", j, !1), y.addEventListener("oTransitionEnd", j, !1), y.addEventListener("otransitionend", j, !1), y.addEventListener("transitionend", j, !1)), window.addEventListener("resize", j, !1)) : window.onresize = function() { n() }, {
                    setup: function() { n() },
